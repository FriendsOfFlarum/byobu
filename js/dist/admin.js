...
var ByobuSetingsPage = /*#__PURE__*/function (_ExtensionPage) {
  ...
  _proto.content = function content() {
    return [m("div", {
    ...
    }, m(flarum_common_components_Badge__WEBPACK_IMPORTED_MODULE_2___default.a, {
      ...
      setting: this.setting
    }, m("h2", null, flarum_common_helpers_icon__WEBPACK_IMPORTED_MODULE_3___default()(this.setting('fof-byobu.icon-postAction').toJSON() || this.postActionDefault)))), m("p", null, app.translator.trans('flarum-tags.admin.edit_tag.icon_text', {
      a: m("a", {
