...
/* harmony import */ var flarum_forum_components_DiscussionPage__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! flarum/forum/components/DiscussionPage */ "flarum/forum/components/DiscussionPage");
/* harmony import */ var flarum_forum_components_DiscussionPage__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(flarum_forum_components_DiscussionPage__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var flarum_forum_components_DiscussionHero__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! flarum/forum/components/DiscussionHero */ "flarum/forum/components/DiscussionHero");
/* harmony import */ var flarum_forum_components_DiscussionHero__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(flarum_forum_components_DiscussionHero__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var flarum_forum_states_DiscussionListState__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! flarum/forum/states/DiscussionListState */ "flarum/forum/states/DiscussionListState");
/* harmony import */ var flarum_forum_states_DiscussionListState__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(flarum_forum_states_DiscussionListState__WEBPACK_IMPORTED_MODULE_10__);
...
/* harmony import */ var flarum_forum_utils_DiscussionControls__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! flarum/forum/utils/DiscussionControls */ "flarum/forum/utils/DiscussionControls");
/* harmony import */ var flarum_forum_utils_DiscussionControls__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(flarum_forum_utils_DiscussionControls__WEBPACK_IMPORTED_MODULE_12__);
...
function hero() {
  Object(flarum_common_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_forum_components_DiscussionHero__WEBPACK_IMPORTED_MODULE_9___default.a.prototype, 'items', function (items) {
    var discussion = this.attrs.discussion;
...
function apiInclude() {
  Object(flarum_common_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_forum_components_DiscussionPage__WEBPACK_IMPORTED_MODULE_8___default.a.prototype, 'requestParams', function (params) {
    // @todo this removes posts from the discussion :'(
    if (!params.include) params.include = 'recipientUsers,recipientGroups';else params.include = params.include + ',recipientUsers,recipientGroups';
  });
  Object(flarum_common_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_forum_states_DiscussionListState__WEBPACK_IMPORTED_MODULE_10___default.a.prototype, 'requestParams', function (params) {
...
function controls() {
  Object(flarum_common_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_forum_utils_DiscussionControls__WEBPACK_IMPORTED_MODULE_12___default.a, 'moderationControls', function (items, discussion) {
    ...
    if (discussion && discussion.recipientUsers().find(function (user) {
      ...
      items.add('remove', flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_6___default.a.component({
        ...
        onclick: function onclick() {
          if (discussion) {
            var recipients = new flarum_common_utils_ItemList__WEBPACK_IMPORTED_MODULE_13___default.a();
...
function privacyToggle(app) {
  Object(flarum_common_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_forum_components_SettingsPage__WEBPACK_IMPORTED_MODULE_1___default.a.prototype, 'privacyItems', function (items) {
    ...
    items.add('byobu-block-dm', flarum_common_components_Switch__WEBPACK_IMPORTED_MODULE_2___default.a.component({
...
function sharedMessageHistory(app) {
  Object(flarum_common_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_forum_components_UserPage__WEBPACK_IMPORTED_MODULE_7___default.a.prototype, 'navItems', function (items) {
    ...
    items.add('byobu', flarum_common_components_LinkButton__WEBPACK_IMPORTED_MODULE_8___default.a.component({
      href: href,
      icon: app.forum.data.attributes['byobu.icon-badge']
...
var AddRecipientModal = /*#__PURE__*/function (_Modal) {
  ...
  _proto.content = function content() {
    return [m("div", {
      ...
      icon: 'fas fa-check'
    }, app.translator.trans('fof-byobu.forum.buttons.submit')), flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_3___default.a.component({
...
function recipientCountLabel(count, attrs) {
  ...
  var label = app.translator.trans('fof-byobu.forum.labels.recipients', {
    count: count
  });
...
/* harmony import */ var flarum_common_models_User__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! flarum/common/models/User */ "flarum/common/models/User");
/* harmony import */ var flarum_common_models_User__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(flarum_common_models_User__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var flarum_common_models_Group__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! flarum/common/models/Group */ "flarum/common/models/Group");
/* harmony import */ var flarum_common_models_Group__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(flarum_common_models_Group__WEBPACK_IMPORTED_MODULE_3__);
...
function recipientLabel(recipient, attrs) {
  ...
  attrs.style = attrs.style || {};
  attrs.className = 'RecipientLabel ' + (attrs.className || '');
  attrs.href = flarum_common_utils_extract__WEBPACK_IMPORTED_MODULE_0___default()(attrs, 'link');
  var label;

  if (recipient instanceof flarum_common_models_User__WEBPACK_IMPORTED_MODULE_2___default.a) {
    label = flarum_common_helpers_username__WEBPACK_IMPORTED_MODULE_1___default()(recipient);

    if (attrs.href) {
      attrs.title = recipient.username() || '';
      attrs.href = app.route.user(recipient);
    }
  } else if (recipient instanceof flarum_common_models_Group__WEBPACK_IMPORTED_MODULE_3___default.a) {
  ...
  return flarum_common_components_LinkButton__WEBPACK_IMPORTED_MODULE_4___default.a.component(attrs, label);
}
...
/* harmony import */ var flarum_common_models_Group__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! flarum/common/models/Group */ "flarum/common/models/Group");
/* harmony import */ var flarum_common_models_Group__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(flarum_common_models_Group__WEBPACK_IMPORTED_MODULE_10__);
...
var RecipientSearch = /*#__PURE__*/function (_Search) {
  ...
  _proto.view = function view() {
    ...
    return m('div', {
      ...
      className: 'RecipientsInput FormControl ' + flarum_common_utils_classList__WEBPACK_IMPORTED_MODULE_5___default()({
      ...
      type: 'search',
      placeholder: flarum_common_utils_extractText__WEBPACK_IMPORTED_MODULE_6___default()(app.translator.trans('fof-byobu.forum.input.search_recipients')),
      ...
      className: 'Dropdown-menu Search-results fade ' + flarum_common_utils_classList__WEBPACK_IMPORTED_MODULE_5___default()({
        "in": !!loading
      })
    }, !this.doSearch ? flarum_common_components_LoadingIndicator__WEBPACK_IMPORTED_MODULE_7___default.a.component({
      size: 'tiny',
  ...
  _proto.sourceItems = function sourceItems() {
    var items = new flarum_common_utils_ItemList__WEBPACK_IMPORTED_MODULE_4___default.a(); // Add user source based on permissions.
  ...
  _proto.removeRecipient = function removeRecipient(recipient, e) {
    ...
    if (recipient instanceof flarum_common_models_User__WEBPACK_IMPORTED_MODULE_9___default.a) {
      type = 'users';
    }

    if (recipient instanceof flarum_common_models_Group__WEBPACK_IMPORTED_MODULE_10___default.a) {
      type = 'groups';
    }
