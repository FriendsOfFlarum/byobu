...
class DiscussionAddedBlueprint implements BlueprintInterface, MailableInterface
{
    ...
    public function __construct(Discussion $discussion, User $actor, TranslatorInterface $trans, SettingsRepositoryInterface $settings)
    {
    ...
    {
        return ['text' => 'byobu::emails.privateDiscussionAdded'];
    }
    ...
    public function getEmailSubject()
    {
        ...
        return $this->trans->trans('fof-byobu.notifications.private_discussion_added.title', [
